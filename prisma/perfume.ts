...
export const seedPerfumes = [
  ...
  },
  {
    ...
    topNotes: ['Bulgarian Rose', 'Hawthorn', 'Black Currant', 'Mandarin Orange'],
    heartNotes: ['Parma Violet', 'Rose', 'Opoponax', 'Jasmine'],
  ...
  },
  {
    ...
    heartNotes: ['Pineapple', 'Patchouli', 'Maroccan Jasmine'],
    baseNotes: ['Birch', 'Musk', 'Oakmoss', 'Ambroxan', 'Cedarwood'],
